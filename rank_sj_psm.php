...
<? if (!isset($_POST['generalka']) AND !isset($_POST['obecny'])){
	?>
...
<?
$sql88="SELECT * FROM `ranks_sk` WHERE `ussid` !=1 AND `skoki_psm` > 0 ORDER BY `skoki_psm` DESC";
$result88=mysqli_query($conn, $sql88);

$sql70="SELECT `skoki_psm` FROM `ranks_sk` WHERE `ussid` !=1 ORDER BY `skoki_psm` DESC LIMIT 1";
$tete71 = mysqli_fetch_assoc(mysqli_query($conn, $sql70));
$najlepszy171 = $tete71['skoki_psm'];



while($r = mysqli_fetch_assoc($result88)) {
$points = $r['skoki_psm'];
$wynik10=mysqli_query($conn, "SELECT count(*) FROM `ranks_sk` WHERE `skoki_psm` > '$points' AND `ussid` !=1");
$wynik1=mysqli_fetch_array($wynik10);
$pozycja=1+$wynik1[0];
$id_uss = $r['ussid'];

$strata = $r['skoki_psm']-$najlepszy171;
...
if($pozycja == 1){
	echo "<tr height=\"30\" style=\"background-color: gold;\"><td width=\"5%\" align=\"center\">".$pozycja."</td><td width=\"6%\" align=\"center\"><img src=\"".$usersdata['nation'].".png\" width=\"20px\" height=\"10px\"></td><td width=\"75%\" align=\"center\"><img src=\"".$usersdata['picture']."\" width=\"20px\" height=\"20px\"><a href=\"profile.php?id=".$id_uss."\">".$mojeid.$usersdata['first_name']." ".$usersdata['last_name'].$mojeid1."</a></td><td width=\"7%\" align=\"center\">".$r['skoki_psm']."</td><td width=\"7%\" align=\"center\">".$strata."</td></tr>";
}
if($pozycja == 2){
...
<tr height="30"><td width="5%" align="center">POZ</td><td width="6%" align="center">Nat</td><td width="75%" align="center">Imię i nazwisko</td><td width="7%" align="center">PKT</td><td width="7%" align="center">Strata</td></tr>
<?
$sql88="SELECT * FROM `ranks_sk` WHERE `ussid` !=1 AND `skoki_psm_o` > 0 ORDER BY `joined_psm` ASC";
$result88=mysqli_query($conn, $sql88);

$sql70="SELECT `skoki_psm_o` FROM `ranks_sk` WHERE `ussid` !=1 ORDER BY `skoki_psm_o` DESC LIMIT 1";
$tete71 = mysqli_fetch_assoc(mysqli_query($conn, $sql70));
$najlepszy171 = $tete71['skoki_psm_o'];


while($r = mysqli_fetch_assoc($result88)) {
$points = $r['skoki_psm_o'];
$wynik10=mysqli_query($conn, "SELECT count(*) FROM `ranks_sk` WHERE `skoki_psm_o` > '$points' AND `ussid` !=1");
$wynik1=mysqli_fetch_array($wynik10);
$pozycja=$r['joined_psm']-1;
$id_uss = $r['ussid'];

$strata = $r['skoki_psm_o']-$najlepszy171;
...
if($pozycja == 1){
	echo "<tr height=\"30\" style=\"background-color: gold;\"><td width=\"5%\" align=\"center\">".$pozycja."</td><td width=\"6%\" align=\"center\"><img src=\"".$usersdata['nation'].".png\" width=\"20px\" height=\"10px\"></td><td width=\"75%\" align=\"center\"><img src=\"".$usersdata['picture']."\" width=\"20px\" height=\"20px\"><a href=\"profile.php?id=".$id_uss."\">".$mojeid.$usersdata['first_name']." ".$usersdata['last_name'].$mojeid1."</a></td><td width=\"7%\" align=\"center\">".$r['skoki_psm_o']."</td><td width=\"7%\" align=\"center\">".$strata."</td></tr>";
}
if($pozycja == 2){
	echo "<tr height=\"30\" style=\"background-color: silver;\"><td width=\"5%\" align=\"center\">".$pozycja."</td><td width=\"6%\" align=\"center\"><img src=\"".$usersdata['nation'].".png\" width=\"20px\" height=\"10px\"></td><td width=\"75%\" align=\"center\"><img src=\"".$usersdata['picture']."\" width=\"20px\" height=\"20px\"><a href=\"profile.php?id=".$id_uss."\">".$mojeid.$usersdata['first_name']." ".$usersdata['last_name'].$mojeid1."</a></td><td width=\"7%\" align=\"center\">".$r['skoki_psm_o']."</td><td width=\"7%\" align=\"center\">".$strata."</td></tr>";
}
