...
if($pozycja == 1){
	echo "<tr height=\"30\" style=\"background-color: gold;\"><td width=\"5%\" align=\"center\">".$pozycja."</td><td width=\"6%\" align=\"center\"><img src=\"".$usersdata['nation'].".png\" width=\"20px\" height=\"10px\"></td><td width=\"75%\" align=\"center\"><img src=\"".$usersdata['picture']."\" width=\"20px\" height=\"20px\"><a href=\"profile.php?id=".$id_uss."\">".$mojeid.$usersdata['first_name']." ".$usersdata['last_name'].$mojeid1."</a></td><td width=\"7%\" align=\"center\">".$r['skoki_psk']."</td><td width=\"7%\" align=\"center\">".$strata."</td></tr>";
}
if($pozycja == 2){
...
if($pozycja == 1){
	echo "<tr height=\"30\" style=\"background-color: gold;\"><td width=\"5%\" align=\"center\">".$pozycja."</td><td width=\"6%\" align=\"center\"><img src=\"".$usersdata['nation'].".png\" width=\"20px\" height=\"10px\"></td><td width=\"75%\" align=\"center\"><img src=\"".$usersdata['picture']."\" width=\"20px\" height=\"20px\"><a href=\"profile.php?id=".$id_uss."\">".$mojeid.$usersdata['first_name']." ".$usersdata['last_name'].$mojeid1."</a></td><td width=\"7%\" align=\"center\">".$r['skoki_psk_o']."</td><td width=\"7%\" align=\"center\">".$strata."</td></tr>";
}
if($pozycja == 2){
	echo "<tr height=\"30\" style=\"background-color: silver;\"><td width=\"5%\" align=\"center\">".$pozycja."</td><td width=\"6%\" align=\"center\"><img src=\"".$usersdata['nation'].".png\" width=\"20px\" height=\"10px\"></td><td width=\"75%\" align=\"center\"><img src=\"".$usersdata['picture']."\" width=\"20px\" height=\"20px\"><a href=\"profile.php?id=".$id_uss."\">".$mojeid.$usersdata['first_name']." ".$usersdata['last_name'].$mojeid1."</a></td><td width=\"7%\" align=\"center\">".$r['skoki_psk_o']."</td><td width=\"7%\" align=\"center\">".$strata."</td></tr>";
}
